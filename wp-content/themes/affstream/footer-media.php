...
<footer id="footer-media" class="site-footer">
	<div class="container">
        ...
        <p class="footer-media-text-desktop">
            <?php the_field('footer_media_text', 'option') ?>
        </p>
			...
			if($social):
				...
				<div class="social-links">
					<div class="social-links-container">
						...
						<a class="social-link" target="_blank" aria-label="telegram" href="<?= $social['telegram'] ?>">
						...
						<a class="social-link" target="_blank" aria-label="instagram" href="<?= $social['instagram'] ?>">
						...
						<a class="social-link" target="_blank" aria-label="facebook"  href="<?= $social['facebook'] ?>">
                        ...
                        ?>
						<a class="social-link" target="_blank" aria-label="other_social"  href="<?= $social['other_social']?>">
                        ...
                        if ($social['linkedin']):
                        ?>
						<a class="social-link" target="_blank" aria-label="linkedin" href="<?= $social['linkedin'] ?>">
							<svg width="22" height="22" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<?php if($social['email']):?>
						<a class="mail-link" aria-label="email" href="mailto:<?= $social['email'] ?>"><?= $social['email'] ?></a>
					<?php endif; ?>
				</div>
			<?php
			endif;
