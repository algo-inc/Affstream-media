...
import { assign, tinyState, cache, isArray, isStringValue, asArray, hasOwnProperty, seq, StateMachine, invariant, isPromise, optionalFunctionValue, isEmpty, callEach, bindNot, either, isPositive, greaterThan, defaultTo, noop, isNotEmpty, isNotNullish, deferThrow, text, isUndefined, isNull, isFunction, numberEquals } from 'vest-utils';
import { Isolate, VestRuntime, IsolateSelectors, Walker, Bus, IsolateInspector, Reconciler } from 'vestjs-runtime';
...
class SuiteOptionalFields {
    ...
    static getOptionalField(suite, fieldName) {
        var _a;
        return (_a = suite.data.optional[fieldName]) !== null && _a !== void 0 ? _a : {};
    }
...
function createSuite(...args) {
    ...
    return VestRuntime.Run(stateRef, () => {
        ...
        VestRuntime.persist(suite), Object.assign(Object.assign({ dump: VestRuntime.persist(() => VestRuntime.useHistoryRoot()[0]), get: VestRuntime.persist(useCreateSuiteResult), remove: Bus.usePrepareEmitter(Events.REMOVE_FIELD), reset: Bus.usePrepareEmitter(Events.RESET_SUITE), resetField: Bus.usePrepareEmitter(Events.RESET_FIELD), resume: VestRuntime.persist(useLoadSuite) }, bindSuiteSelectors(VestRuntime.persist(useCreateSuiteResult))), getTypedMethods()));
    });
}
