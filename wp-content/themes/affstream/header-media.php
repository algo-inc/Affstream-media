...
<div id="page" class="site">
	<header id="header-media" class="site-header">
		<div class="container desktop-menu">
			...
			<nav id="site-navigation" class="main-navigation">
				<?php
				wp_nav_menu(array(
					'theme_location' => 'media-menu-header',
					'container' => 'nav',
					'container_class' => 'media-menu-header-class'
				));
				?>
			</nav>
		...
		<nav class="mobile-menu">
			...
			<div class="logout-container buttons-container">
				<a href="https://cp.affstream.com/affiliate/dashboard/" class="dashboard auth-button button-signin">Dashboard</a>
